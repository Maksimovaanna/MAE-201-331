...
public:
    ...
    const QByteArray pin_hash_code_orig = "202cb962ac59075b964b07152d234b70"; //hex
    ...
    const QString encrypt_file_name = "C:/201-331_Maksimova/data.json";
    const QString open_file_name = "C:/201-331_Maksimova/open_data.json";
    QFile encrypt_file;
    ...
    QVector<QVector<QString>> data_vector; //название сайта и зашифрованная строчка логин+пароль
